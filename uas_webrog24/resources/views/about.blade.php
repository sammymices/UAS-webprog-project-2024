                ...
                <div class="row mt-5">
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card-custom">
                            ...
                            <p class="card-text"><strong>Visi:</strong> Menjadi yayasan yang memberikan kontribusi nyata
                                dalam meningkatkan kesejahteraan anak-anak dan masyarakat yang membutuhkan.</p>
                            <p class="card-text"><strong>Misi:</strong> Memberikan pendidikan, pelatihan keterampilan,
                                serta bantuan sosial bagi mereka yang kurang mampu dan membutuhkan di Indonesia.</p>
                        </div>
                    </div>
                </div>
            </div>
