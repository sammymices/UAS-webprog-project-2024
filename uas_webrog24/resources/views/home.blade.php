        ...
        <div class="container h-100 d-flex align-items-center justify-content-end">
            <div class="row h-100">
                <div class="col-lg-6 col-sm-12 hero-tagline my-auto">
                    ...
                    <p>
                        <span class="fw-bold">Bersama Al Mubarok, </span>kita menanam nilai-nilai Islam. Bersama-sama,
                        kita wujudkan masa depan yang gemilang
                    </p>
                    <button class="button-lg-secondary me-4"
                        onclick="window.location.href='{{ url('/donasi') }}'">Donasi</button>
                    <a href="{{ url('/donasi') }}">
                        <img src="{{ asset('Assets/Right Arrow.png') }}" alt="">
                    </a>
                </div>
            </div>
            <img src="{{ asset('Assets/yayasan2.png') }}" class="position-absolute end-0 me-5"
                style="padding-right: 90px; padding-top: 27px" width="auto" height="450" alt="">
